...
def banner():
    ...
    runntxt(Y+"      ██║  ██║    ██║  ██║    ██║  ██╗    ██║    ██████╔╝")
    runntxt(GG+"      ╚═╝  ╚═╝    ╚═╝  ╚═╝    ╚═╝  ╚═╝    ╚═╝    ╚═════╝ ")
    runntxt(WW+"      Fb-Id- https://www.facebook.com/Dj.Rakib.420")
    runntxt(GG+"     ...... What's apk- 01746951657")
    time.sleep(1.5)
    print GG+"  √=============================================√"
    ...
    print WW+"  |        TEAM : DJ-420-HACKER-VOICE-BOX       |"
...
print GG+"╭────\033[91m[\033[96m RAKIB-OK ID\033[95m / \033[96mUsername Target\033[91m ] "
email_target = str(raw_input(GL+"\033[92m╰────➲\033[93m  "))
print " "
print "\033[92m╭────\033[91m[ \033[96mRAKIB-OK File Wordlist \033[95m( pass.txt ) \033[91;1m]"
